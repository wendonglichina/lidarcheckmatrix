...
class WheelAngle : public ::google::protobuf::Message {
 public:
  ...
  inline ::google::protobuf::int64 angle() const;
  inline void set_angle(::google::protobuf::int64 value);
...
inline ::google::protobuf::int64 VehSpeed::speed() const {
  // @@protoc_insertion_point(field_get:CANProto.VehSpeed.speed)
  return speed_;
}
inline void VehSpeed::set_speed(::google::protobuf::int64 value) {
  set_has_speed();
  speed_ = value;
...
inline ::google::protobuf::int64 WheelAngle::angle() const {
  // @@protoc_insertion_point(field_get:CANProto.WheelAngle.angle)
  return angle_;
}
inline void WheelAngle::set_angle(::google::protobuf::int64 value) {
  set_has_angle();
  angle_ = value;
